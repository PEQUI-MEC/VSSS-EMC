...
# objeto visionROI
cc/vision/visionROI.o: cc/vision/visionROI.cpp
	@echo "\n\n\033[92mCompiling visionROI object...\033[0m\n"
	@$(COMPILER) -c `pkg-config --cflags opencv` "cc/vision/visionROI.cpp" `pkg-config --libs opencv` -o "cc/vision/visionROI.o"
