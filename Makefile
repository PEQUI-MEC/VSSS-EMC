...
VSSS: welcome cc/vision/gmm.o cc/vision/tag.o cc/vision/vision.o cc/vision/visionGUI.o cc/TestFrame.o pack-capture/capture/v4lcap.o pack-capture-gui/capture-gui/V4LInterface-aux.o pack-capture-gui/capture-gui/V4LInterface-events.o cc/Fuzzy/FuzzyController.o cc/Fuzzy/FuzzyFunction.o cc/Fuzzy/Rules.o cc/main.o
