...
VSSS: cc/vision/vision.o cc/vision/tag.o cc/TestFrame.o pack-capture/capture/v4lcap.o pack-capture-gui/capture-gui/V4LInterface-aux.o pack-capture-gui/capture-gui/V4LInterface-events.o cc/Fuzzy/FuzzyController.o cc/Fuzzy/FuzzyFunction.o cc/Fuzzy/Rules.o
...
pack-capture-gui/capture-gui/V4LInterface-aux.o:
...
pack-capture-gui/capture-gui/V4LInterface-events.o:
...
cc/Fuzzy/FuzzyController.o:
	g++ -c -g -m64 -pipe -Wall -W -std=c++11 "cc/Fuzzy/FuzzyController.cpp" -o "cc/Fuzzy/FuzzyController.o"

cc/Fuzzy/FuzzyFunction.o:
	g++ -c -g -m64 -pipe -Wall -W -std=c++11 "cc/Fuzzy/FuzzyFunction.cpp" -o "cc/Fuzzy/FuzzyFunction.o"

cc/Fuzzy/Rules.o:
	g++ -c -g -m64 -pipe -Wall -W -std=c++11 "cc/Fuzzy/Rules.cpp" -o "cc/Fuzzy/Rules.o"
