g++ -std=c++11 -c `pkg-config --cflags opencv` "cc/vision/vision.cpp" `pkg-config --libs opencv` -o "cc/vision/vision.o" -lboost_thread -lboost_system
