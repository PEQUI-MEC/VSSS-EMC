...
void ControlGUI::_robot_status(){
    std::string cmd[5] = {"A@BAT#", "B@BAT#", "C@BAT#", "D@BAT#", "E@BAT#"};
...
void ControlGUI::_create_pid_frame(){
...
void ControlGUI::_event_pid_edit_bt_clicked(){
    if (!pid_edit_flag) {
        pid_edit_flag = true;
...
void ControlGUI::_event_pid_send_bt_clicked() {
    if (!checkPIDvalues()) {
